    ...
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        for(var i = 0; i < 100; i ++)
        {
            vehiculos.Add(new 
            {
                ...
                PrecioMantenimiento = faker.Random.Decimal(100, 2000),
        ...
        const string sql = """
                INSERT INTO public.vehiculos
                    ...
                    values(@id, @Vin, @Modelo, @Pais, @Departamento, @Provincia, @Ciudad, @Calle, @PrecioMonto, @PrecioTipoMoneda, @PrecioMantenimiento, @PrecioMantenimientoTipoMoneda, @Accessorios, @FechaUltima)
        """;
